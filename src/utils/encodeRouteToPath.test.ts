...
describe('#encodeRouteToPath', () => {
  ...
  it('wraps ether input for exact output multihop', () => {
    expect(encodeRouteToPath(route_weth_0_1, true)).toEqual(
      '0x0000000000000000000000000000000000000002000bb80000000000000000000000000000000000000001000bb84200000000000000000000000000000000000006'
    )
  })
  ...
  it('wraps ether output for exact output multihop', () => {
    expect(encodeRouteToPath(route_0_1_weth, true)).toEqual(
      '0x4200000000000000000000000000000000000006000bb80000000000000000000000000000000000000002000bb80000000000000000000000000000000000000001'
    )
  })
})
